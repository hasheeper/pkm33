...
export const MOVES = {
	...
	counter: {
		...
		accuracy: 100,
		basePower: 0,
		damageCallback: 'reflect', // 标记为反弹技能，实际逻辑在 move-handlers.js
		category: "Physical",
		isReflectMove: true, // 软编码标记：反弹技能
		reflectCategory: 'physical', // 反弹物理伤害
		name: "Counter",
		pp: 20,
		priority: -5,
		flags: { contact: 1, protect: 1, failmefirst: 1, noassist: 1, failcopycat: 1 },
		beforeTurnCallback: null,
		onTry: null,
		condition: null,
		secondary: null,
		target: "scripted",
	...
	metalburst: {
		...
		category: "Physical",
		isReflectMove: true, // 软编码标记：反弹技能
		reflectCategory: 'any', // 反弹任意伤害（物理+特殊）
		name: "Metal Burst",
		pp: 10,
		priority: 0,
	...
	mirrorcoat: {
		...
		category: "Special",
		isReflectMove: true, // 软编码标记：反弹技能
		reflectCategory: 'special', // 反弹特殊伤害
		name: "Mirror Coat",
		pp: 20,
		priority: -5,
